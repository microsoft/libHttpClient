...
{
    VERIFY_ARE_EQUAL_STR_HELPER(expected->Data(), actual, actualName.c_str(), errorInfo);
}
...
{
    VERIFY_ARE_EQUAL_STR_HELPER(expected->Data(), actual->Data(), actualName.c_str(), errorInfo);
}
...
{
    VERIFY_ARE_EQUAL_STR_HELPER(expected, actual, actualName.c_str(), errorInfo);
}
