...
#if HC_PLATFORM_IS_MICROSOFT
// TRACELOGGING_DEFINE_PROVIDER_STORAGE and the const decl below are used instead of
// TRACELOGGING_DEFINE_PROVIDER to keep `g_hTraceLoggingProvider` linkage internal.
// This avoids link-time collisions in any static consumers (`g_hTraceLoggingProvider` is very common).
TRACELOGGING_DEFINE_PROVIDER_STORAGE(
    g_lhcTraceLoggingProviderStorage,
    "libHttpClient",
    (0x2b6274b2, 0x159f, 0x4e6f, 0xb8, 0x0, 0xd, 0x17, 0x0, 0x9e, 0x14, 0x7a) // {2B6274B2-159F-4E6F-B800-0D17009E147A}
);

const TraceLoggingHProvider g_hTraceLoggingProvider = &g_lhcTraceLoggingProviderStorage;
