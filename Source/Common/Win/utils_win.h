...
http_internal_wstring utf16_from_utf8(_In_z_ const_utf8_string utf8);

http_internal_string utf8_from_utf16(_In_reads_(size) PCWSTR utf16, size_t size);
http_internal_wstring utf16_from_utf8(_In_reads_(size) const_utf8_string utf8, size_t size);
