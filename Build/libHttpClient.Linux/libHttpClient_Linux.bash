...
if [ "$BUILD_STATIC" = false ]; then
    ...
    sudo cmake -S "$SCRIPT_DIR" -B "$SCRIPT_DIR"/../../Int/CMake/libHttpClient.Linux -D CMAKE_BUILD_TYPE=$CONFIGURATION -D CMAKE_C_COMPILER=clang-11 -D CMAKE_CXX_COMPILER=clang++-11
    sudo make -C "$SCRIPT_DIR"/../../Int/CMake/libHttpClient.Linux
fi