...
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DOPENSSL_THREADS)
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DOPENSSL_NO_STATIC_ENGINE)
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -D__STDC_NO_ATOMICS__)
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DOPENSSL_PIC)
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DOPENSSL_USE_NODELETE)
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DUNICODE)

target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DOPENSSLDIR="THIS_SHOULD_NOT_BE_USED")
target_compile_options(${CRYPTO_PROJECT_NAME} PRIVATE -DENGINESDIR="THIS_SHOULD_NOT_BE_USED")
