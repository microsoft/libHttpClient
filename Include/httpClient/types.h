...
{
    HC_WEBSOCKET_CLOSE_NORMAL = 1,
    HC_WEBSOCKET_CLOSE_GOING_AWAY = 2,
    HC_WEBSOCKET_CLOSE_PROTOCOL_ERROR = 3,
    HC_WEBSOCKET_CLOSE_UNSUPPORTED = 4, 
    HC_WEBSOCKET_CLOSE_ABNORMAL_CLOSE = 4,
    HC_WEBSOCKET_CLOSE_INCONSISTENT_DATATYPE = 5,
    HC_WEBSOCKET_CLOSE_POLICY_VIOLATION = 6,
    HC_WEBSOCKET_CLOSE_TOO_LARGE = 7,
    HC_WEBSOCKET_CLOSE_NEGOTIATE_ERROR = 8,
    HC_WEBSOCKET_CLOSE_SERVER_TERMINATE = 9,
    HC_WEBSOCKET_CLOSE_UNKNOWN_ERROR = 10
