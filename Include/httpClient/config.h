...
// see http://www.unix.org/version2/whatsnew/lp64_wp.html for detailed descriptions
    ...
    #include <winapifamily.h>
        ...
        #define HC_PLATFORM HC_PLATFORM_GXDK
    #endif
...
#define HC_PLATFORM_IS_MICROSOFT \
   (HC_PLATFORM == HC_PLATFORM_WIN32 || HC_PLATFORM == HC_PLATFORM_UWP || HC_PLATFORM == HC_PLATFORM_XDK || HC_PLATFORM == HC_PLATFORM_GXDK)
