...
If you are building libHttpClient from source, you can provide an hc_settings.props file to customize how the library gets built. When built, the libHttpClient projects look for an hc_settings.props file in any directory above the the repository root. Currently, the following build customizations are available:
